...
export default function Footer() {
  ...
  return <>
      ...
      <div className="mt-5  bg-footer text-black ">
          <div className="p-10">
            <h2 className=' text-2xl'>Get The FreshCart app</h2>
            <p className=' mt-2 text-gray-400'>We Will Send You a link, Open it On Your Phone to download the app</p>
            <div className="flex flex-wrap my-3 ">
              <div className="lg:w-10/12 w-full">
                  <input type="email" placeholder='Email..' className='w-full outline-none p-1.5 border border-gray-300 rounded-md' />
              </div>
              <div className="w-full lg:w-2/12">
                  <button className='btn w-full  bg-green-600 text-white rounded py-1.5  lg:ms-6 mt-5 lg:mt-0 '>Share App Link</button>
              </div>
            </div>
