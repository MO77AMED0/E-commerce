...
export default function ForgetPassword() {
  ...
  return (
   ...
   <div className='py-16 w-1/2 mx-auto'>
    <h1 className='text-3xl py-6 font-semibold text-center'>Write your email</h1>
    ...
    <form onSubmit={formik.handleSubmit}>
          ...
          {userSubmit
           ...
           : <button type="submit" className=" mt-10 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Send</button>
          }
    </form>
   </div>
  </>
